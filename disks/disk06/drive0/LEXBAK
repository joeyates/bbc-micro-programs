    1 MODE 1
    5 N=32:DIM W$(4,8),W(4,8):W=N:BC=30:WL=10:LL=10:HC=0:ML=0:BX=20:BY=0
   10FOR I=1 TO 4:FOR J=1 TO 8:READ W$(I,J),W(I,J):NEXT J,I
   20REM          SHUFFLE
   30FOR K=1 TO 40:REM NO. OF SHUFFLES
   40A=RND(4):B=RND(8):C=RND(4):D=RND(8)
   50E=W(A,B):W(A,B)=W(C,D):W(C,D)=E:E$=W$(A,B):W$(A,B)=W$(C,D):W$(C,D)=E$
   60NEXT K
   70REM     THE GAME

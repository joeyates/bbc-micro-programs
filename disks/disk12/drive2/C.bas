  ...
  150.endgame JSR toxy:LDA #32:JSR OSWRCH:RTS
  155.backin JSR press:JSR choice:JMP top
  160.fx LDA #4:LDX #1:JSR OSBYTE:LDA #16:LDX #1:JSR OSBYTE:LDA #229:LDX #1:JSR OSBYTE:RTS
  165.time0 LDA #2:LDX #zero MOD 256:LDY #zero DIV 256:JSR OSWORD:RTS
  167.zero EQUD 0:EQUB 0
  ...
  840.son LDX #&8E:LDY #&FF:LDA #&81:JSR OSBYTE:CPX #&FF:BNE getout:LDX #0:LDY #0:LDA #210:JSR OSBYTE
  845.getout LDX #&8F:LDY #&FF:LDA #&81:JSR OSBYTE:CPX #&FF:BNE hilo:PLA:PLA:JMP top
 ...
 1380NEXT PASS
 1390CALL lexis
 1395T%=(TIME/100)+?penal%-1
 1400VDU 31,0,2,131,157,132,141:PRINT;"Your TIME :";T%;" seconds"
 1410VDU 31,0,3,131,157,132,141:PRINT;"Your TIME :";T%;" seconds"
 1420CALL backin
 1430GOTO1395

  ...
  120 PROCassemble
  130 H%?10=base+4
  140 H%?(H%?10+0)=200:H%?(H%?10+1)=0
  150 H%?(H%?10+2)=234:H%?(H%?10+3)=1
  153 GCOL 0,1
  155 CALLfill
  160 H%?10=H%?10+4
  170 H%?(H%?10+0)=200:H%?(H%?10+1)=0
  180 H%?(H%?10+2)=234:H%?(H%?10+3)=0
  183 GCOL 0,2
  185 CALLfill
  190 H%?10=H%?10+4
  200 H%?(H%?10+0)=200:H%?(H%?10+1)=0
  210 H%?(H%?10+2)=50:H%?(H%?10+3)=0
  220 GCOL 0,3
  230 CALLfill
  240 END
  250 DEF PROCassemble
  260 FOR PASS=0 TO 2 STEP 2
  270 P%=G%
  280 [OPT PASS
  290 .fill JSR pop
  300 .UP   LDY #2
